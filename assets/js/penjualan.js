          ...
          <div class="max-w-md w-full bg-white rounded-3xl p-8 shadow-xl border border-stone-200 z-10 space-y-6 animate-fade-in">
            <div class="text-center space-y-3">
              ...
              <div>
                ...
                <p class="text-xs text-stone-500 mt-1 font-medium">Dashboard Rekapitulasi & Penjualan</p>
              </div>
            </div>
            ...
            <form onsubmit="handleLoginSubmit(event)" class="space-y-4">
              ...
              <div class="space-y-1.5">
                <label class="text-xs font-semibold text-stone-700">Username</label>
                <div class="relative">
            ...
            <div>
              <div class="p-5 border-b border-stone-100 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-[10px] text-stone-500 font-medium">Rekap & Kasir Penjualan</p>
                  </div>
                </div>
              ...
              <nav class="${AppState.mobileMenuOpen ? 'block' : 'hidden'} md:block p-3 space-y-1 text-xs font-semibold">
                <button 
                  ...
                  class="w-full flex items-center space-x-3 px-3.5 py-2.5 rounded-xl transition ${AppState.activeTab === 'dashboard' ? 'bg-red-600 text-white shadow-md shadow-red-600/20' : 'hover:bg-stone-100 text-stone-600 hover:text-stone-900'}"
                >
                ...
                <button 
                  ...
                  class="w-full flex items-center space-x-3 px-3.5 py-2.5 rounded-xl transition ${AppState.activeTab === 'rekap' ? 'bg-red-600 text-white shadow-md shadow-red-600/20' : 'hover:bg-stone-100 text-stone-600 hover:text-stone-900'}"
                >
                  <i data-lucide="bar-chart-3" class="w-4 h-4"></i>
                  <span>Rekap Penjualan</span>
                  <span class="ml-auto bg-red-100 text-red-800 text-[9px] font-extrabold px-1.5 py-0.5 rounded-md">Periode</span>
                </button>

                <button 
                  onclick="AppState.activeTab='transactions'; AppState.mobileMenuOpen=false; AppState.render();"
                  class="w-full flex items-center space-x-3 px-3.5 py-2.5 rounded-xl transition ${AppState.activeTab === 'transactions' ? 'bg-red-600 text-white shadow-md shadow-red-600/20' : 'hover:bg-stone-100 text-stone-600 hover:text-stone-900'}"
                >
                  <i data-lucide="receipt" class="w-4 h-4"></i>
                  <span>Data Transaksi</span>
                  <span class="ml-auto bg-stone-100 text-stone-600 text-[10px] px-2 py-0.5 rounded-md font-mono border border-stone-200">${AppState.salesRaw.length}</span>
                </button>

                ${session.role === 'Owner' ? `
                  <button 
                    onclick="AppState.activeTab='users'; AppState.mobileMenuOpen=false; AppState.render();"
                    class="w-full flex items-center space-x-3 px-3.5 py-2.5 rounded-xl transition ${AppState.activeTab === 'users' ? 'bg-red-600 text-white shadow-md shadow-red-600/20' : 'hover:bg-stone-100 text-stone-600 hover:text-stone-900'}"
                  >
                ...
                <button 
                  ...
                  class="w-full flex items-center space-x-3 px-3.5 py-2.5 rounded-xl transition ${AppState.activeTab === 'activity' ? 'bg-red-600 text-white shadow-md shadow-red-600/20' : 'hover:bg-stone-100 text-stone-600 hover:text-stone-900'}"
                >
                ...
                <button 
                  ...
                  class="w-full flex items-center space-x-3 px-3.5 py-2.5 rounded-xl transition ${AppState.activeTab === 'settings' ? 'bg-red-600 text-white shadow-md shadow-red-600/20' : 'hover:bg-stone-100 text-stone-600 hover:text-stone-900'}"
                >
            ...
            <div class="${AppState.mobileMenuOpen ? 'block' : 'hidden'} md:block p-4 border-t border-stone-100 bg-stone-50/50">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2.5 overflow-hidden">
                  ...
                  <div class="truncate">
                    <p class="text-xs font-bold text-stone-900 truncate">${session.name || session.username}</p>
            ...
            <header class="bg-white border-b border-stone-200 px-6 py-4 flex flex-wrap items-center justify-between gap-4 sticky top-0 z-20 shadow-xs">
              <div>
                ...
                <div class="flex items-center space-x-2 mt-0.5">
                  ...
                  <span class="inline-flex items-center text-[11px] font-medium ${AppState.apiConnectionStatus.success ? 'text-red-700' : 'text-stone-600'}">
                    <span class="w-1.5 h-1.5 rounded-full ${AppState.apiConnectionStatus.success ? 'bg-red-500' : 'bg-stone-400'} mr-1.5 animate-pulse"></span>
              ...
              <div class="flex items-center space-x-2.5">
                <button 
                  ...
                  class="px-3 py-1.5 bg-white hover:bg-stone-100 text-stone-700 text-xs font-semibold rounded-xl flex items-center space-x-1.5 transition border border-stone-200 shadow-2xs"
                >
                  <i data-lucide="rotate-cw" class="w-3.5 h-3.5 ${AppState.loading ? 'animate-spin text-red-600' : ''}"></i>
                  <span>Refresh</span>
                </button>

                <button 
                  onclick="openAddTxModal()" 
                  class="px-3.5 py-1.5 bg-red-600 hover:bg-red-700 text-white text-xs font-bold rounded-xl flex items-center space-x-1.5 shadow-md shadow-red-600/20 transition active:scale-95"
                >
      ...
      return `
        <div class="space-y-6 animate-fade-in">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-3 relative overflow-hidden">
              <div class="flex items-center justify-between">
                <span class="text-xs font-semibold text-stone-500">Total Omzet Penjualan</span>
                <div class="p-2.5 bg-red-50 text-red-600 rounded-xl border border-red-100">
                  <i data-lucide="wallet" class="w-5 h-5"></i>
                </div>
              </div>
              <div>
                <p class="text-2xl font-extrabold text-stone-900 font-mono tracking-tight">${formatIDR(metrics.totalOmzet)}</p>
                <p class="text-[11px] text-stone-500 mt-1 font-medium">Status Lunas & Sukses</p>
              </div>
            </div>

            <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-3 relative overflow-hidden">
              <div class="flex items-center justify-between">
                <span class="text-xs font-semibold text-stone-500">Total Transaksi</span>
                <div class="p-2.5 bg-teal-50 text-teal-600 rounded-xl border border-teal-100">
                  <i data-lucide="shopping-bag" class="w-5 h-5"></i>
                </div>
              </div>
              <div>
                <p class="text-2xl font-extrabold text-stone-900 font-mono tracking-tight">${metrics.totalTxCount}</p>
                <p class="text-[11px] text-stone-500 mt-1 font-medium">${metrics.completedCount} Selesai, ${metrics.pendingCount} Pending</p>
              </div>
            </div>

            <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-3 relative overflow-hidden">
              <div class="flex items-center justify-between">
                <span class="text-xs font-semibold text-stone-500">Rata-rata Order</span>
                <div class="p-2.5 bg-stone-100 text-stone-700 rounded-xl border border-stone-200">
                  <i data-lucide="trending-up" class="w-5 h-5"></i>
                </div>
              </div>
              <div>
                <p class="text-2xl font-extrabold text-stone-900 font-mono tracking-tight">${formatIDR(metrics.avgTxValue)}</p>
                <p class="text-[11px] text-stone-500 mt-1 font-medium">Per Transaksi Selesai</p>
              </div>
            </div>

            <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-3 relative overflow-hidden">
              <div class="flex items-center justify-between">
                <span class="text-xs font-semibold text-stone-500">Omzet Hari Ini</span>
                <div class="p-2.5 bg-amber-50 text-amber-600 rounded-xl border border-amber-100">
                  <i data-lucide="calendar" class="w-5 h-5"></i>
                </div>
              </div>
              <div>
                <p class="text-2xl font-extrabold text-stone-900 font-mono tracking-tight">${formatIDR(metrics.todayOmzet)}</p>
                <p class="text-[11px] text-stone-500 mt-1 font-medium">Tanggal ${new Date().toLocaleDateString('id-ID')}</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-2xl border border-stone-200 shadow-xs overflow-hidden">
            <div class="p-5 border-b border-stone-100 flex items-center justify-between">
              <div>
                ...
                <p class="text-xs text-stone-500">Daftar transaksi terkini dari sistem kasir/checkout Corat Coret Layar</p>
              </div>
              <button 
                onclick="AppState.activeTab='transactions'; AppState.render();" 
                class="text-xs font-bold text-red-700 hover:text-red-800 transition flex items-center space-x-1"
              >
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-left text-xs">
                <thead class="bg-stone-50/80 text-stone-600 font-semibold border-b border-stone-200">
                  <tr>
                ...
                <tbody class="divide-y divide-stone-100">
                  ...
                  ` : AppState.salesRaw.slice(0, 5).map(tx => `
                    <tr class="hover:bg-stone-50/80 cursor-pointer transition" onclick="openTxDetail('${tx.invoice || tx.id}')">
                      <td class="py-3.5 px-4 font-mono font-bold text-red-700">${tx.invoice || tx.id}</td>
                      <td class="py-3.5 px-4 text-stone-500">${formatDate(tx.date || tx.created_at)}</td>
                      <td class="py-3.5 px-4 font-semibold text-stone-800">${tx.customer || 'Pelanggan Umum'}</td>
                      <td class="py-3.5 px-4 text-stone-600">${tx.product || tx.items || 'Layanan Cetak'}</td>
                      <td class="py-3.5 px-4 font-extrabold text-stone-900 font-mono">${formatIDR(tx.total || tx.amount || 0)}</td>
    ...
    function renderMonthlySalesRecapTab() {
      ...
      return `
        <div class="space-y-6 animate-fade-in">
          <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs flex flex-wrap gap-4 items-center justify-between">
            <div>
              <h3 class="font-bold text-stone-900 text-sm">Pilih Periode Rekap Penjualan</h3>
              <p class="text-xs text-stone-500">Filter berdasarkan bulan atau tanggal spesifik</p>
            </div>

            <div class="flex flex-wrap items-center gap-3">
              <div class="bg-stone-100 p-1 rounded-xl flex items-center space-x-1 text-xs font-semibold">
                <button 
                  onclick="AppState.rekapMode='month'; AppState.render();" 
                  class="px-3 py-1.5 rounded-lg transition ${AppState.rekapMode === 'month' ? 'bg-white text-red-700 shadow-xs font-bold' : 'text-stone-600 hover:text-stone-900'}"
                >
                  Per Bulan
                </button>
                <button 
                  onclick="AppState.rekapMode='date'; AppState.render();" 
                  class="px-3 py-1.5 rounded-lg transition ${AppState.rekapMode === 'date' ? 'bg-white text-red-700 shadow-xs font-bold' : 'text-stone-600 hover:text-stone-900'}"
                >
                  Per Tanggal
                </button>
              </div>
              ...
              ${AppState.rekapMode === 'month' ? `
                <div class="relative">
                  <select 
                    ...
                    class="pl-3.5 pr-8 py-2 bg-stone-50 border border-stone-200 text-stone-800 rounded-xl text-xs font-bold focus:ring-2 focus:ring-red-500 focus:outline-none transition appearance-none cursor-pointer"
                  >
                    ${MONTH_NAMES.map((name, index) => `
                      <option value="${index}" ${selMonth === index ? 'selected' : ''}>${name}</option>
                    `).join('')}
                  </select>
                  <i data-lucide="chevron-down" class="w-4 h-4 text-stone-400 absolute right-2.5 top-1/2 -transtone-y-1/2 pointer-events-none"></i>
                </div>
              ...
              ` : `
                <input 
                  ...
                  class="px-3 py-2 bg-stone-50 border border-stone-200 text-stone-800 font-mono rounded-xl text-xs font-bold focus:ring-2 focus:ring-red-500 focus:outline-none"
                />
              `}

              <button 
                onclick="exportPeriodSales()" 
                class="px-3.5 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl text-xs font-bold flex items-center space-x-1.5 transition shadow-sm"
              >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-red-600 text-white p-5 rounded-2xl shadow-md space-y-2 relative overflow-hidden">
              <span class="text-xs font-semibold text-red-100">Total Omzet (${periodLabel})</span>
              <p class="text-2xl font-extrabold font-mono tracking-tight">${formatIDR(totalOmzetBulan)}</p>
              <p class="text-[11px] text-red-100 font-medium">${completedCountBulan} Transaksi Sukses</p>
            </div>

            <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-2">
              <span class="text-xs font-semibold text-stone-500">Jumlah Produk Terjual</span>
              <p class="text-2xl font-extrabold text-stone-900 font-mono tracking-tight">${totalQtyBulan} <span class="text-xs text-stone-500 font-normal">item</span></p>
              <p class="text-[11px] text-stone-500 font-medium">Terhitung dari pesanan lunas</p>
            </div>

            <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-2">
              <span class="text-xs font-semibold text-stone-500">Rata-rata Order</span>
              <p class="text-2xl font-extrabold text-stone-900 font-mono tracking-tight">${formatIDR(avgOrderBulan)}</p>
              <p class="text-[11px] text-stone-500 font-medium">Per transaksi periode ini</p>
            </div>

            <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-2">
              <span class="text-xs font-semibold text-stone-500">Transaksi Pending</span>
              <p class="text-2xl font-extrabold text-amber-600 font-mono tracking-tight">${pendingCountBulan} <span class="text-xs text-stone-500 font-normal">pesanan</span></p>
              <p class="text-[11px] text-stone-500 font-medium">Menunggu pelunasan</p>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 bg-white rounded-2xl border border-stone-200 p-5 shadow-xs space-y-4">
              <div class="flex items-center justify-between border-b pb-3 border-stone-100">
                <h3 class="font-bold text-stone-900 text-sm flex items-center space-x-2">
                  <i data-lucide="trophy" class="w-4 h-4 text-red-600"></i>
                  <span>Produk Terlaris (${periodLabel})</span>
                </h3>
                <span class="text-xs text-stone-500 font-medium">${sortedProducts.length} Kategori Produk</span>
              </div>
                ...
                <table class="w-full text-left text-xs">
                  ...
                  <tbody class="divide-y divide-stone-100">
                    ...
                    ` : sortedProducts.map(([pName, pStat]) => `
                      <tr>
                        <td class="py-3 px-3 font-semibold text-stone-800">${pName}</td>
                        <td class="py-3 px-3 text-center font-mono font-medium text-stone-600">${pStat.qty}</td>
                        <td class="py-3 px-3 text-right font-bold text-red-700 font-mono">${formatIDR(pStat.omzet)}</td>
                      </tr>
                    `).join('')}
                  </tbody>
                </table>
            ...
            <div class="bg-white rounded-2xl border border-stone-200 p-5 shadow-xs space-y-4">
              <div class="border-b pb-3 border-stone-100">
                <h3 class="font-bold text-stone-900 text-sm flex items-center space-x-2">
              ...
              <div class="space-y-3">
                ${Object.keys(paymentStats).length === 0 ? `
                  <p class="text-xs text-stone-400 text-center py-6">Belum ada transaksi pada periode ini.</p>
                ` : Object.entries(paymentStats).map(([method, stat]) => {
                  ...
                  return `
                    <div class="p-3 bg-stone-50 rounded-xl border border-stone-100 space-y-1.5">
                      <div class="flex justify-between text-xs font-bold text-stone-800">
                        <span>${method}</span>
                        <span class="font-mono text-red-700">${formatIDR(stat.omzet)}</span>
                      </div>
          ...
          <div class="bg-white rounded-2xl border border-stone-200 shadow-xs overflow-hidden">
            <div class="p-5 border-b border-stone-100 flex items-center justify-between">
              <div>
                <h3 class="font-bold text-stone-900 text-sm">Daftar Transaksi ${periodLabel}</h3>
                <p class="text-xs text-stone-500">Rincian seluruh transaksi penjualan periode terpilih</p>
              </div>
              <span class="bg-stone-100 text-stone-700 text-xs px-2.5 py-1 rounded-lg font-mono font-bold">${periodSales.length} data</span>
            </div>
                  ...
                  ${periodSales.length === 0 ? `
                    <tr>
                      <td colspan="8" class="py-12 text-center text-stone-400">
                        <i data-lucide="calendar-x" class="w-8 h-8 mx-auto mb-2 text-stone-300"></i>
                        Tidak ada transaksi tercatat untuk ${periodLabel}.
                      </td>
                    </tr>
                  ` : periodSales.map(tx => `
                    <tr class="hover:bg-stone-50 cursor-pointer transition" onclick="openTxDetail('${tx.invoice || tx.id}')">
                      <td class="py-3.5 px-4 font-mono font-bold text-red-700">${tx.invoice || tx.id}</td>
                      <td class="py-3.5 px-4 text-stone-500">${formatDate(tx.date || tx.created_at)}</td>
                      <td class="py-3.5 px-4 font-semibold text-stone-800">${tx.customer || 'Pelanggan Umum'}</td>
                      <td class="py-3.5 px-4 text-stone-600">${tx.product || tx.items || 'Layanan Cetak'}</td>
                      <td class="py-3.5 px-4 text-stone-600 font-mono">${tx.qty || 1}</td>
                      <td class="py-3.5 px-4 font-extrabold text-stone-900 font-mono">${formatIDR(tx.total || tx.amount || 0)}</td>
                      <td class="py-3.5 px-4 text-stone-600">${tx.payment_method || 'QRIS'}</td>
                      <td class="py-3.5 px-4">${renderStatusBadge(tx.status)}</td>
                    </tr>
                  `).join('')}
                </tbody>
            ...
            <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
              <div class="relative flex-1 sm:w-64">
                ...
                <input 
                  ...
                  class="w-full pl-10 pr-4 py-2 bg-stone-50 border border-stone-200 text-stone-800 rounded-xl text-xs focus:bg-white focus:ring-2 focus:ring-red-500 focus:outline-none placeholder:text-stone-400"
                />
              </div>
              ...
              <div class="relative">
                <select 
                  ...
                  class="pl-3.5 pr-8 py-2 bg-stone-50 border border-stone-200 text-stone-800 rounded-xl text-xs font-bold focus:ring-2 focus:ring-red-500 focus:outline-none cursor-pointer"
                >
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-left text-xs">
                ...
                <tbody class="divide-y divide-stone-100">
                  ...
                  ` : filtered.map(tx => `
                    <tr class="hover:bg-stone-50 transition cursor-pointer" onclick="openTxDetail('${tx.invoice || tx.id}')">
                      <td class="py-3.5 px-4 font-mono font-bold text-red-700">${tx.invoice || tx.id}</td>
                      <td class="py-3.5 px-4 text-stone-500">${formatDate(tx.date || tx.created_at)}</td>
                      <td class="py-3.5 px-4 font-semibold text-stone-800">${tx.customer || 'Pelanggan Umum'}</td>
                      <td class="py-3.5 px-4 text-stone-600">${tx.product || tx.items || 'Layanan Cetak'}</td>
      ...
      return `
        <div class="space-y-6 animate-fade-in">
          <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs flex items-center justify-between">
            <div>
              <h3 class="font-bold text-stone-900 text-sm">Log Aktivitas Sistem</h3>
              <p class="text-xs text-stone-500">Catatan riwayat tindakan pengguna dan aktivitas di dashboard</p>
            </div>
            <span class="bg-stone-100 text-stone-700 text-xs px-2.5 py-1 rounded-lg font-mono font-bold">${logs.length} catatan</span>
          </div>
                ...
                <tbody class="divide-y divide-stone-100">
                  ...
                  ` : logs.map(l => `
                    <tr class="hover:bg-stone-50 transition">
                      <td class="py-3.5 px-4 text-stone-500 font-mono">${formatDate(l.timestamp)}</td>
                      <td class="py-3.5 px-4 font-bold text-stone-900">${l.username}</td>
                      <td class="py-3.5 px-4 text-stone-700 font-medium">${l.action}</td>
                    </tr>
                  `).join('')}
                </tbody>
              </table>
      ...
      return `
        <div class="max-w-xl space-y-6 animate-fade-in">
          <div class="bg-white p-6 rounded-2xl border border-stone-200 shadow-xs space-y-5">
            <div>
              <h3 class="font-bold text-stone-900 text-sm">Pengaturan Connection Endpoint API</h3>
              <p class="text-xs text-stone-500 mt-1">Konfigurasikan alamat URL backend REST API server untuk sinkronisasi otomatis transaksi.</p>
            </div>

            <form onsubmit="handleSaveApiSettings(event)" class="space-y-4 text-xs">
              <div class="space-y-1.5">
                <label class="font-semibold text-stone-700">Base URL API Server</label>
                <div class="relative">
                  <span class="absolute inset-y-0 left-0 pl-3.5 flex items-center text-stone-400">
                  ...
                  <input 
                    ...
                    class="w-full pl-10 pr-4 py-2.5 bg-stone-50 border border-stone-200 text-stone-800 rounded-xl font-mono focus:bg-white focus:ring-2 focus:ring-red-500 focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div class="pt-2 flex items-center justify-between border-t border-stone-100">
                <button 
                  ...
                  class="px-3 py-2 text-stone-500 hover:text-stone-800 text-xs font-semibold rounded-xl hover:bg-stone-100 transition"
                >
                  Reset Default
                </button>
                <button 
                  type="submit" 
                  class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl shadow-md transition"
                >
                  Simpan & Hubungkan
                </button>
              </div>
    ...
    function renderAddTxModal() {
      ...
      return `
        <div class="fixed inset-0 bg-stone-900/40 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div class="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4 border border-stone-200 text-stone-800">
            <div class="flex items-center justify-between border-b pb-3 border-stone-100">
              <h3 class="font-bold text-stone-900 text-sm">Input Transaksi Penjualan Baru</h3>
              <button onclick="closeAddTxModal()" class="text-stone-400 hover:text-stone-600 p-1 rounded-lg">
            ...
            <form onsubmit="handleAddTxSubmit(event)" class="space-y-3 text-xs">
              <div>
                <label class="block font-semibold text-stone-700 mb-1">Nomor Invoice</label>
                <input 
                  type="text" 
                  id="tx-invoice" 
                  value="${autoInv}" 
                  required 
                  class="w-full px-3.5 py-2 bg-stone-50 border border-stone-200 rounded-xl font-mono text-stone-800 focus:bg-white focus:ring-2 focus:ring-red-500 focus:outline-none" 
                />
              </div>

              <div>
                <label class="block font-semibold text-stone-700 mb-1">Nama Pelanggan</label>
                <input 
                  type="text" 
                  id="tx-customer" 
                  placeholder="Contoh: Budi Santoso" 
                  required 
                  class="w-full px-3.5 py-2 bg-stone-50 border border-stone-200 rounded-xl text-stone-800 focus:bg-white focus:ring-2 focus:ring-red-500 focus:outline-none" 
                />
              </div>

              <div>
                <label class="block font-semibold text-stone-700 mb-1">Nama Produk / Layanan</label>
                <input 
                  type="text" 
                  id="tx-product" 
              ...
              <div class="grid grid-cols-2 gap-3">
                <div>
                  <label class="block font-semibold text-stone-700 mb-1">Qty (Jumlah)</label>
                  <input 
                    type="number" 
                    id="tx-qty" 
                    value="1" 
                ...
                <div>
                  <label class="block font-semibold text-stone-700 mb-1">Total (Rp)</label>
                  <input 
                    type="number" 
                    id="tx-total" 
                    placeholder="75000" 
              ...
              <div class="grid grid-cols-2 gap-3">
                <div>
                  <label class="block font-semibold text-stone-700 mb-1">Metode Pembayaran</label>
                  <select id="tx-payment" class="w-full px-3 py-2 bg-stone-50 border border-stone-200 rounded-xl text-stone-800 focus:bg-white focus:ring-2 focus:ring-red-500 focus:outline-none">
                ...
                <div>
                  <label class="block font-semibold text-stone-700 mb-1">Status Pembayaran</label>
                  <select id="tx-status" class="w-full px-3 py-2 bg-stone-50 border border-stone-200 rounded-xl text-stone-800 focus:bg-white focus:ring-2 focus:ring-red-500 focus:outline-none">
              ...
              <div class="pt-3 flex justify-end space-x-2 border-t border-stone-100">
                <button type="button" onclick="closeAddTxModal()" class="px-4 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-xl font-bold">Batal</button>
                <button type="submit" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl font-bold shadow-md">Simpan Transaksi</button>
              </div>
            </form>
          </div>
        </div>
    ...
    function renderUserManagementTab(session) {
      ...
      return `
        <div class="space-y-6 animate-fade-in">
          <div class="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs flex items-center justify-between">
            <div>
              <h3 class="font-bold text-stone-900 text-sm">Manajemen Akun Admin & Kasir</h3>
              <p class="text-xs text-stone-500">Buatkan akun baru untuk staf/admin agar bisa login ke dashboard</p>
            </div>
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-left text-xs">
                ...
                <tbody class="divide-y divide-stone-100">
                  ${users.map(u => `
                    <tr class="hover:bg-stone-50 transition">
                      <td class="py-3.5 px-4 font-bold text-stone-900 font-mono">${u.username}</td>
                      <td class="py-3.5 px-4 font-semibold text-stone-700">${u.name}</td>
                      <td class="py-3.5 px-4">
                        <span class="px-2.5 py-0.5 rounded-full text-[10px] font-bold ${u.role === 'Owner' ? 'bg-amber-100 text-amber-800 border border-amber-200' : 'bg-red-100 text-red-800 border border-red-200'}">
                          ${u.role}
                        </span>
                      </td>
                      <td class="py-3.5 px-4 text-stone-500">${formatDate(u.createdAt)}</td>
    ...
    function renderAddUserModal() {
      return `
        <div class="fixed inset-0 bg-stone-900/40 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div class="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4 border border-stone-200 text-stone-800">
            <div class="flex items-center justify-between border-b pb-3 border-stone-100">
              <h3 class="font-bold text-stone-900 text-sm">Buat Akun Admin Baru</h3>
              <button onclick="AppState.addUserModalOpen = false; AppState.render();" class="text-stone-400 hover:text-stone-600 p-1 rounded-lg">
                <i data-lucide="x" class="w-5 h-5"></i>
              </button>
            </div>
            ...
            <form onsubmit="handleCreateUserSubmit(event)" class="space-y-3 text-xs">
              ...
              <div>
                <label class="block font-semibold text-stone-700 mb-1">Username Login</label>
                <input 
                  type="text" 
                  id="new-username" 
              ...
              <div>
                <label class="block font-semibold text-stone-700 mb-1">Nama Lengkap Admin</label>
                <input 
                  type="text" 
                  id="new-fullname" 
              ...
              <div>
                <label class="block font-semibold text-stone-700 mb-1">Peran Akses</label>
                <select id="new-role" class="w-full px-3 py-2 bg-stone-50 border border-stone-200 rounded-xl text-stone-800 focus:bg-white focus:ring-2 focus:ring-red-500 focus:outline-none">
              ...
              <div class="pt-3 flex justify-end space-x-2 border-t border-stone-100">
                <button type="button" onclick="AppState.addUserModalOpen = false; AppState.render();" class="px-4 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-xl font-bold">Batal</button>
                <button type="submit" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl font-bold shadow-md">Simpan Akun</button>
              </div>
            </form>
          </div>
        </div>
      ...
      return `
        <div class="fixed inset-0 bg-stone-900/40 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div class="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4 border border-stone-200 text-stone-800">
            <div class="flex items-center justify-between border-b pb-3 border-stone-100">
              <div>
                <h3 class="font-bold text-stone-900 font-mono text-sm">${tx.invoice || tx.id}</h3>
                <p class="text-[11px] text-stone-500">${formatDate(tx.date || tx.created_at)}</p>
              </div>
              <button onclick="closeTxDetail()" class="text-stone-400 hover:text-stone-600 p-1 rounded-lg">
                <i data-lucide="x" class="w-5 h-5"></i>
              </button>
            </div>

            <div class="space-y-3 text-xs">
              <div class="bg-stone-50 p-3.5 rounded-xl border border-stone-200/80 space-y-1">
                <p class="text-stone-500 font-medium">Pelanggan</p>
                <p class="font-bold text-stone-900">${tx.customer || 'Pelanggan Umum'}</p>
              </div>

              <div class="bg-stone-50 p-3.5 rounded-xl border border-stone-200/80 space-y-1">
                <p class="text-stone-500 font-medium">Produk / Layanan</p>
                <p class="font-bold text-stone-900">${tx.product || tx.items || 'Layanan Cetak'}</p>
                <p class="text-stone-500">Jumlah Qty: ${tx.qty || 1}</p>
              </div>

              <div class="flex justify-between items-center bg-stone-50 p-3.5 rounded-xl border border-stone-200/80">
                <div>
                  <p class="text-stone-500 font-medium">Total Pembayaran</p>
                  <p class="font-extrabold text-stone-900 font-mono text-base">${formatIDR(tx.total || tx.amount || 0)}</p>
                </div>
                <div>
              ...
              <div class="bg-stone-50 p-3.5 rounded-xl border border-stone-200/80 space-y-1">
                <p class="text-stone-500 font-medium">Metode Pembayaran</p>
                <p class="font-bold text-stone-900">${tx.payment_method || 'QRIS'}</p>
              </div>
            </div>

            <div class="pt-2 flex justify-between items-center border-t border-stone-100">
              <button 
              ...
              <div class="flex items-center space-x-2">
                <button 
                  ...
                  class="px-3.5 py-2 bg-red-50 hover:bg-red-100 text-red-700 border border-red-200 text-xs font-bold rounded-xl flex items-center space-x-1.5 transition"
                >
                  <i data-lucide="pencil" class="w-3.5 h-3.5"></i>
                  <span>Edit</span>
                </button>
                <button onclick="closeTxDetail()" class="px-4 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 text-xs font-bold rounded-xl">Tutup</button>
              </div>
            </div>
          </div>
        </div>
    ...
    function renderDeleteConfirmModal() {
      ...
      return `
        <div class="fixed inset-0 bg-stone-900/40 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div class="bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl space-y-4 border border-rose-100 text-stone-800">
            <div class="flex items-center space-x-3 text-rose-600">
              ...
              <div>
                <h3 class="font-bold text-stone-900 text-sm">Hapus Transaksi?</h3>
                <p class="text-xs text-rose-600 font-mono">${invNum}</p>
              </div>
            </div>

            <p class="text-xs text-stone-600 leading-relaxed">
              Apakah Anda yakin ingin menghapus transaksi <strong class="text-stone-900">${tx.customer || 'Pelanggan'}</strong> senilai <strong class="text-stone-900">${formatIDR(tx.total || tx.amount || 0)}</strong>? Tindakan ini tidak dapat dibatalkan.
            </p>

            <div class="pt-3 flex justify-end space-x-2 border-t border-stone-100">
              <button 
                onclick="closeDeleteConfirm()" 
                class="px-4 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-xl text-xs font-bold transition"
              >
                Batal
              </button>
              <button 
      ...
      return `
        <div class="fixed inset-0 bg-stone-900/40 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div class="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4 border border-stone-200 text-stone-800">
            <div class="flex items-center justify-between border-b pb-3 border-stone-100">
              <div>
                <h3 class="font-bold text-stone-900 text-sm">Edit Transaksi</h3>
                <p class="text-[11px] text-stone-500 font-mono">${invNum}</p>
              </div>
              <button onclick="closeEditTxModal()" class="text-stone-400 hover:text-stone-600 p-1 rounded-lg">
                <i data-lucide="x" class="w-5 h-5"></i>
              </button>
            </div>
            ...
            <form onsubmit="handleEditTxSubmit(event)" class="space-y-3 text-xs">
              <div>
                <label class="block font-semibold text-stone-700 mb-1">Total / Nominal Harga (Rp)</label>
                <input 
                  type="number" 
                  id="edit-tx-total" 
                  value="${currentTotal}" 
              ...
              <div>
                <label class="block font-semibold text-stone-700 mb-1">Metode Pembayaran</label>
                <select id="edit-tx-payment" class="w-full px-3 py-2 bg-stone-50 border border-stone-200 rounded-xl text-stone-800 focus:bg-white focus:ring-2 focus:ring-red-500 focus:outline-none">
              ...
              <div>
                <label class="block font-semibold text-stone-700 mb-1">Status Pembayaran</label>
                <select id="edit-tx-status" class="w-full px-3 py-2 bg-stone-50 border border-stone-200 rounded-xl text-stone-800 focus:bg-white focus:ring-2 focus:ring-red-500 focus:outline-none">
              ...
              <div class="pt-3 flex justify-end space-x-2 border-t border-stone-100">
                <button type="button" onclick="closeEditTxModal()" class="px-4 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-xl font-bold">Batal</button>
                <button type="submit" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl font-bold shadow-md">Simpan Perubahan</button>
              </div>
            </form>
          </div>
        </div>
    ...
    function renderExitConfirmModal() {
      return `
        <div class="fixed inset-0 bg-stone-900/40 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
          <div class="bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl space-y-4 border border-stone-200 text-stone-800">
            <div class="flex items-center space-x-3 text-stone-700">
              <div class="p-3 bg-stone-100 rounded-2xl border border-stone-200 shrink-0">
                <i data-lucide="log-out" class="w-6 h-6"></i>
              </div>
              <div>
                <h3 class="font-bold text-stone-900 text-sm">Kembali ke Website Utama?</h3>
              </div>
            </div>
            ...
            <div class="pt-3 flex justify-end space-x-2 border-t border-stone-100">
              ...
              <button 
                ...
                class="px-4 py-2 bg-stone-800 hover:bg-stone-900 text-white rounded-xl text-xs font-bold shadow-md transition"
              >
                Ya, Yakin
              </button>
            </div>
